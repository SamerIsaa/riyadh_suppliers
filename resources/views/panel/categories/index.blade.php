@extends('panel.layout.master',['title' => __('panel.categories'),'is_active'=>'categories'])
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('panel.categories')</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="mb-7">
                        <div class="row align-items-center d-flex justify-content-between">
                            ...
                            <div class="col-lg-4 col-xl-4 d-flex justify-content-end">
                                <a href="{{ route('panel.categories.create.index') }}"
